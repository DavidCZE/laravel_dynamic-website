...
<x-karta>
    <div class="flex ">
        <img
            ...
            src="{{$bazarItem->uvodniFotka ? asset('storage/' . $bazarItem->uvodniFotka) : asset('/images/royal-ocean-low-resolution-logo-white-on-black-background.png')}}"
            alt=""
        />
        <div>
            <h3 class="text-2xl">
            ...
            <div class="text-lg mt-4">
                <i class="fa-solid"></i><a href="/bazar/{{$bazarItem['id']}}">{{$bazarItem['rokVyroby']}}</a>
            </div>
            <div>
